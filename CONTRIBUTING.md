...
Thank you for your interest in improving simtools!

## How to contribute

1. **Reporting bugs:** Use the GitHub Issue tracker.
2. **Suggesting features:** Use the GitHub Issue tracker to propose new features or improvements.
3. **Code changes:** All code changes should be submitted via Pull Requests (PRs). Please branch off from `main`.

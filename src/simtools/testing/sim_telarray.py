...
def validate_sim_telarray(
    data_files, log_files, array_models, expected_mc_events=None, expected_shower_events=None
):
    """
...
def validate_log_files(log_files):  # pylint: disable=unused-argument
    """Validate sim_telarray log files."""
    _logger.warning("TO BE IMPLEMENTED TODO")

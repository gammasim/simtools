...
class Simulator:
    ...
    def simulate(self):
        ...
        job_manager.submit(self._results["sub_script"], self._results["sub_out"])
    ...
    def pack_for_register(self, directory_for_grid_upload=None):
        ...
        output_files = self.get_file_list(file_type="sim_telarray_output")
        log_files = self.get_file_list(file_type="sim_telarray_log")
    ...
    def validate_metadata(self):
        ...
        for model in self.array_models:
            files = self.get_file_list(file_type="sim_telarray_output")
    ...
    def _verify_simulated_events_in_sim_telarray(self, expected_shower_events, expected_mc_events):
        ...
        """
        event_errors = []
        for file in self.get_file_list(file_type="sim_telarray_output"):

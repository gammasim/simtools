...
class SimulatorArray(SimtelRunner):
    ...
    def _common_run_command(self, run_number, weak_pointing=None):
        ...
        self._log_file = self.get_file_name(file_type="sim_telarray_log", run_number=run_number)
        histogram_file = self.get_file_name(
            file_type="sim_telarray_histogram", run_number=run_number
        )
        output_file = self.get_file_name(file_type="sim_telarray_output", run_number=run_number)

...
from simtools.simtel.simtel_log_reader import crawl_log_files, parse_log_files
...
def generate_ecsv_output(statistics, output_file, time_window):
    ...
    # Determine all unique run numbers across all thresholds
    all_runs = set()
...
def derive_nsb_triggers(args):
    ...
    parsed_data = parse_log_files(log_files)

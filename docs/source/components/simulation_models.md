...
3. **Simulation model setting workflows**: Parameter derivation and validation pipelines implemented as workflows composed of simtools applications. Maintained in [simulation model setting repository](https://gitlab.cta-observatory.org/cta-science/simulations/simulation-model/simulation-model-parameter-setting).

...
The production of large sets of simulated events is one of the core functionalities of the simtools
...
2. [Configure productions](productions/configure-productions.md)
3. [Run productions](productions/run-productions.md)

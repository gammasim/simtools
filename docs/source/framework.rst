...
modelFilesLocations: list of str
    ...
    verification/data-from-instrument-teams>`_. The location of the directory with the yaml files
    for the model parameters and the sim_telarray config files are required in case useMongoDB is
    set to False. They can be found on gitlab repos `configReports <https://gitlab.cta-observatory.
    org/cta-consortium/aswg/simulations/simulation-model/simulation-model-description/-/tree/master/

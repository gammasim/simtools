...
Before merging the release candidate, confirm that the dependency catalog validates and every
production parent image is selected by digest. See [Dependency versions and provenance](dependency_versions.md).

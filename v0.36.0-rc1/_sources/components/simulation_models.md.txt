...
1. **Model parameter schema files:** The schema files define model-parameter structure and value constraints. See the corresponding [data model section](../data-model/model_parameters.md) for schema details.
...
4. **Simulation model setting workflows**: Parameter derivation and validation pipelines implemented as workflows composed of simtools applications. Maintained in [simulation model setting repository](https://gitlab.cta-observatory.org/cta-science/simulations/simulation-model/simulation-model-parameter-setting).

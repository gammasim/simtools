...
class CorsikaRunner:
    ...
    label: str
        Instance label.
    keep_seeds: bool
        If True, seeds generated by CorsikaConfig, based on the run number and the primary particle\
         will be used. If False, random seeds will be defined automatically by sim_telarray.

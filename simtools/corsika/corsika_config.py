...
class CorsikaConfig:
    ...
    def setup_configuration(self):
        ...
        return {
            ...
            "ERANGE": [
                self.args_dict["energy_range"][0].to("GeV").value,
                self.args_dict["energy_range"][1].to("GeV").value,
            ],
            "THETAP": [
            ...
            "VIEWCONE": [
                self.args_dict["view_cone"][0].to("deg").value,
                self.args_dict["view_cone"][1].to("deg").value,
            ],
            "CSCAT": [

...
from simtools.io.io_table_handler import (
    _merge,
...
TABLE_HANDLER_PATH = "simtools.io.io_table_handler"
...
def mock_logger(mocker):
    """Mock logger."""
    return mocker.patch("simtools.io.io_table_handler._logger")
...
def test_read_table_list_hdf5(mocker):
    ...
    mock_read_hdf5 = mocker.patch(
        "simtools.io.io_table_handler._read_table_list_hdf5",
...
def test_read_table_list_fits(mocker):
    ...
    mock_read_fits = mocker.patch(
        "simtools.io.io_table_handler._read_table_list_fits",
        return_value={"table1": ["table1"], "table2": ["table2"]},
    )

...
def test_fill_product_association_identifier(args_dict_site):
    ...
    workflow_1 = workflow.WorkflowDescription(label="unit-test", args_dict=args_dict_site)
...
def test_merge_config_dicts(args_dict_site):
    ...
    _workflow = workflow.WorkflowDescription(label="unit-test", args_dict=args_dict_site)
...
def test_fill_activity_meta(args_dict_site):
    ...
    file_writer_1 = workflow.WorkflowDescription(label="unit-test", args_dict=args_dict_site)
    file_writer_1.top_level_meta = data_model.top_level_reference_schema()
    file_writer_1._fill_activity_meta()

    file_writer_2 = workflow.WorkflowDescription(label="unit-test", args_dict=args_dict_site)

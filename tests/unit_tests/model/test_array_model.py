...
def test_input_validation(db_connection, io_handler):
    arrayConfigData = {
        "site": "North",
    ...
    am = ArrayModel(label="test", arrayConfigData=arrayConfigData, mongoDBConfigFile=db_connection)
...
def test_exporting_config_files(db_connection, io_handler):
    arrayConfigData = {
        "site": "North",
        "layoutName": "test-layout",
        "modelVersion": "Prod5",

...
EXTERNAL_RESOURCE_TESTS = {
    ...
    "tests/unit_tests/camera/test_camera_efficiency.py::test_calc_partial_efficiency",
    "tests/unit_tests/camera/test_camera_efficiency.py::test_results_summary_nsb_type",
    "tests/unit_tests/camera/test_camera_efficiency.py::test_results_summary_muon_type",
    "tests/unit_tests/camera/test_camera_efficiency.py::test_results_summary_with_custom_nsb_spectrum",
